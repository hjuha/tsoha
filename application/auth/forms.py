...
class RegisterForm(FlaskForm):
	...
	password = PasswordField("Salasana", [validators.Length(min=8, message="Salasanan tulee olla vähintään 8 merkkiä"),
										  validators.Regexp(".*[0-9].*[a-z].*[A-Z].*|.*[0-9].*[A-Z].*[a-z].*|.*[a-z].*[0-9].*[A-Z].*|.*[a-z].*[A-Z].*[0-9].*|.*[A-Z].*[0-9].*[a-z].*|.*[A-Z].*[a-z].*[0-9].*", message="Salasanassa tulee olla pieniä ja isoja kirjaimia sekä numeroita")])
